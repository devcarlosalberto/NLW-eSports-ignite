...
export function CreateAdModal() {
    ...
    return (
        <Dialog.Portal>
            ...
            <Dialog.Content className="fixed bg-[#2A2634] py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 round-lg shadow-lg shadow-black/25 w-[480px]">
                    ...
                    <div className="flex gap-6">
                        ...
                        <div className="flex flex-col gap-2 flex-1">
                            ...
                            <div className="grid grid-cols-2 gap-2">
                                ...
                                <Input id="hourEnd" name="hourEnd" type="time" placeholder="De" />
                            </div>
                        </div>
                    </div>
